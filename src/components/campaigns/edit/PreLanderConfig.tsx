...
export interface PreLanderConfigHandle {
...
const PreLanderConfig = forwardRef<PreLanderConfigHandle, PreLanderConfigProps>(
  (
    {
      prelanderEnabled,
    ...
    useImperativeHandle(
      ...
      () => ({
        focusFirstError: () => {
          const target = headlineError ? headlineRef.current : bodyRef.current;
          if (target) {
...
PreLanderConfig.displayName = "PreLanderConfig";

export default PreLanderConfig;
