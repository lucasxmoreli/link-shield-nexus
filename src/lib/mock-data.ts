export const mockCampaigns = [
  ...
  { id: '2', hash: 'xY7wR2tFhJ', name: 'Meta US - Finance', traffic_source: 'meta' as const, safe_url: 'https://blog.example.com/finance', offer_url: 'https://offer.example.com/fin1', is_active: true, created_at: '2025-03-03T14:30:00Z', domain: 'go.campaigns.io' },
...
export const mockRequestsLog = [
  ...
  { id: '2', campaign_name: 'Meta US - Finance', hash: 'xY7wR2tFhJ', ip_address: '34.120.55.12', country_code: 'US', device_type: 'desktop' as const, user_agent: 'facebookexternalhit/1.1', action_taken: 'bot_blocked' as const, created_at: '2025-03-10T18:30:00Z' },
  ...
  { id: '6', campaign_name: 'Meta US - Finance', hash: 'xY7wR2tFhJ', ip_address: '191.32.100.5', country_code: 'BR', device_type: 'mobile' as const, user_agent: 'Mozilla/5.0 (Linux; Android...)', action_taken: 'offer_page' as const, created_at: '2025-03-10T18:15:00Z' },
