  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-12">
      ...
      <PreLanderConfig
        ...
        prelanderCta={form.prelanderCta} onPrelanderCtaChange={setters.setPrelanderCta}
        powDifficulty={form.powDifficulty} onPowDifficultyChange={setters.setPowDifficulty}
        headlineError={validation.prelanderHeadlineError} bodyError={validation.prelanderBodyError}
      />

      <BehavioralModeConfig
        behavioralMode={form.behavioralMode} onBehavioralModeChange={setters.setBehavioralMode}
      />
