const pt = {
  ...
  domains: {
    ...
    cnameStep3Auto: "Pronto! Sua conexão segura será ativada automaticamente.",
    settingUpSecure: "Configurando conexão segura...",
    settingUpSecureDesc: "Estamos verificando seu DNS e provisionando o SSL. Isso pode levar alguns minutos.",
    refreshStatus: "Atualizar Status",
    sslReady: "Certificado SSL provisionado e domínio pronto para tráfego.",
    type: "Tipo",
    nameHost: "Nome / Host",
    value: "Valor",
    target: "Destino",
    ...
    cnameNote: "Seu domínio é roteado automaticamente pelo nosso proxy seguro com SSL. Nenhuma configuração manual necessária.",
    txtFallbackTitle: "Verificação TXT Alternativa",
    txtFallbackWarning: "Se seu provedor DNS não suporta CNAME na raiz (@), adicione estes dois registros TXT.",
    txtFallbackLink: "Problemas com um domínio raiz (@)? Clique aqui para verificação TXT alternativa.",
