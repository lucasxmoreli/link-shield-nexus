const pt = {
  ...
  domains: {
    ...
    verifyDomainDesc: "Configure o registro DNS para verificar a propriedade de",
    verifyAndSave: "Verificar e Salvar Domínio",
    verifying: "Verificando...",
    verified: "Verificado",
    pending: "Pendente",
    domainVerified: "Domínio verificado com sucesso!",
    txtNotFound: "Registro TXT não encontrado.",
    url: "URL",
    created: "Criado",
    dnsStep1: "Acesse o painel do provedor DNS do seu domínio.",
    dnsStep2: "Crie um registro TXT com os seguintes valores:",
    dnsStep3: "Salve as alterações no painel DNS e aguarde a propagação (até 72h). Volte aqui para verificar.",
    type: "Tipo",
    nameHost: "Nome / Host",
    value: "Valor",
    ...
    cloudflareTitle: "Proteção Cloudflare (Recomendado)",
    cloudflareDesc: "Proteja seu domínio com Cloudflare para ocultar o IP do servidor dos bots de plataformas de anúncios.",
    cloudflareStep1: "Ative a Nuvem Laranja (Proxy) no registro A no DNS do Cloudflare.",
    cloudflareStep2: "Configure o modo SSL/TLS como 'Full' nas configurações do Cloudflare.",
    cloudflareStep3: "Isso impede que bots do Facebook, TikTok e Google descubram o IP real do seu servidor.",
  },
