const pt = {
  ...
  campaigns: {
    ...
    dnsReminder: "Certifique-se de que seu domínio tem um registro A apontando para o IP do servidor (187.124.233.229) com o proxy da Cloudflare ativo (nuvem laranja).",
  },
  ...
  campaignEdit: {
    ...
    domainLabel: "Domínio",
    domainHelper: "Seu domínio deve ter um registro A → 187.124.233.229 com proxy Cloudflare ativo.",
    domainTooltip: 'Exemplo: Se você selecionar "track.meusite.com", seu link será "track.meusite.com/c/xyz". Configure um registro A apontando para 187.124.233.229 com a nuvem laranja ativa no Cloudflare.',
    ...
    step2: "Certifique-se de que seu domínio tem um <bold>registro A apontando para 187.124.233.229</bold> com proxy Cloudflare (nuvem laranja) ativo.",
  ...
  domains: {
    ...
    domainPending: "Domínio ainda pendente. Certifique-se de que seu registro A aponta para 187.124.233.229 com proxy Cloudflare (nuvem laranja) ativo.",
    ...
    dnsNotPointing: "DNS ainda não aponta para o servidor. Verifique seu registro A na Cloudflare.",
    url: "URL",
    created: "Criado",
    sslStatus: "SSL",
    valueCopied: "IP copiado!",
    dnsStep1: "Acesse a Cloudflare e adicione seu domínio (o plano Free funciona).",
    dnsStep2: "Crie um registro A apontando para:",
