const pt = {
  ...
  dashboard: {
    ...
    botsBlockedSub: "ameaças identificadas",
    safePageHits: "Safe Page",
    safePageHitsSub: "redirecionamentos cloaker",
    realTraffic: "Tráfego Real",
    realTrafficSub: "visitantes limpos",
    ...
    hourly: "Hora",
    daily: "Dia",
    noTrafficYet: "Sem tráfego ainda — escudo armado.",
    shieldWatching: "Quando seus links começarem a girar, o gráfico ganha vida aqui em tempo real.",
    // [PR-3d.2] Empty state magnético do LiveStream
    liveStreamEmptyTitle: "Aguardando o primeiro clique...",
    liveStreamEmptyDesc: "Cada visitante aparecerá aqui em tempo real — IP, país, dispositivo e veredito do escudo.",
    realLabel: "Real",
    blockedLabel: "Bloqueado",
    liveStream: "Live Stream",
    noTrafficDetected: "Nenhum tráfego detectado ainda.",
    statusClean: "LIMPO",
  ...
  campaigns: {
    ...
    gatePaidPlan: "Criação de campanhas é recurso de plano pago.",
    gatePaidPlanShort: "Recurso de plano pago",
    gatePastDue: "Pagamento pendente — regularize para continuar criando.",
    gatePastDueShort: "Pagamento pendente",
    gateCanceled: "Assinatura encerrada.",
    gateCanceledShort: "Assinatura encerrada",
    badgeAtCap: "Máximo do {{plan}}",
    badgeOverLimit: "Acima do limite do {{plan}} · {{used}} de {{effective}}",
    viewOnlyHint: "Modo visualização — limites do tenant não estão disponíveis aqui.",
    viewOnlyAdd: "Modo visualização",
    ...
    // [PR-3d.2] Empty state magnético da Campaigns
    emptyTitle: "Pronto pra blindar sua primeira oferta?",
    emptyDesc: "Cada campanha é um link blindado contra bots, espiões da Meta/TikTok e auditoria das plataformas. Configure em 1 minuto.",
    emptyCta: "Criar minha primeira campanha",
    emptyTitleLocked: "Desbloqueie a criação de campanhas",
    emptyDescLocked: "Faça upgrade do seu plano e comece a proteger seu tráfego hoje mesmo.",
    emptyCtaLocked: "Ver planos",
    hash: "Hash",
    name: "Nome",
    source: "Fonte",
    date: "Data",
    ...
    deleteConfirmMessage: "Tem certeza que deseja excluir a campanha {{name}}? Esta ação não pode ser desfeita.",
  ...
  campaignEdit: {
    ...
    prelanderEnabledTitle: "Ativar Pre-Lander",
    prelanderEnabledDesc: "Mostra uma página intermediária com conteúdo legítimo antes da oferta. Recomendado para nichos sensíveis.",
    prelanderHeadlineLabel: "Título do Pre-Lander",
    prelanderHeadlinePlaceholder: "ex: Saúde Masculina — Antes de Continuar",
    prelanderHeadlineRequired: "O título do Pre-Lander é obrigatório",
    prelanderFieldsRequired: "Preencha os campos obrigatórios do Pre-Lander",
    prelanderBodyLabel: "Texto do Pre-Lander",
    prelanderBodyPlaceholder: "Texto exibido ao visitante enquanto verificamos a conexão. Evite mencionar o produto diretamente.",
    prelanderBodyRequired: "O texto do Pre-Lander é obrigatório",
    prelanderCtaLabel: "Texto do botão",
    prelanderCtaPlaceholder: "Continuar",
    powDifficultyLabel: "Dificuldade da verificação",
    powDifficulty3Helper: "Rápida (~1s) — menos rigorosa",
    powDifficulty4Helper: "Equilibrada (~2-3s) — recomendado",
    powDifficulty5Helper: "Rigorosa (~5-8s) — pode afetar a conversão",

    behavioralModeSection: "Modo de proteção",
    behavioralModeProtectTitle: "Proteger leads (recomendado)",
    behavioralModeProtectDesc: "Prioriza não bloquear usuários reais. Ideal para a maioria dos nichos.",
    behavioralModeAggressiveTitle: "Anti-revisor (agressivo)",
    behavioralModeAggressiveDesc: "Proteção mais forte contra revisores de plataformas. Pode bloquear humanos passivos.",
    behavioralModeAggressiveWarning: "Recomendado apenas com o Pre-Lander ativo.",
  ...
  domains: {
    ...
    gatePaidPlan: "Domínios personalizados são recurso de plano pago.",
    gatePaidPlanShort: "Recurso de plano pago",
    gatePastDue: "Pagamento pendente — regularize para continuar criando.",
    gatePastDueShort: "Pagamento pendente",
    gateCanceled: "Assinatura encerrada.",
    gateCanceledShort: "Assinatura encerrada",
    gateOverLimit: "Acima do limite do plano — remova o excedente ou faça upgrade.",
    gateOverLimitDetail: "{{used}} de {{effective}} — remova o excedente ou compre slots (em breve).",
    badgeAtCap: "Máximo do {{plan}}",
    badgeOverLimit: "Acima do limite do {{plan}} · {{used}} de {{effective}}",
    ...
    // [PR-3d.2] Empty state magnético dos Domains
    emptyTitle: "Conecte seu primeiro domínio",
    emptyDesc: "Sem domínio = sem tráfego limpo. Configure em 2 minutos com SSL automático via Cloudflare e comece a proteger seus links agora.",
    emptyCta: "Adicionar meu primeiro domínio",
    emptyTitleLocked: "Plano atual não permite domínios",
    emptyDescLocked: "Upgrade pra liberar seus domínios personalizados e blindar suas ofertas.",
    emptyCtaLocked: "Ver planos",
  ...
  billing: {
    ...
    tabPlans: "Planos",
    tabPacks: "Pacotes",
    checkoutComingSoon: "Em breve",
    needBannerPlans: "Para adicionar {{resource}} você precisa de um plano.",
    needResourceDomain: "domínios",
    needResourceCampaign: "campanhas",
    needResourceClicks: "cliques",

    packs: {
      headerTitle: "Uso e fôlego do plano",
      headerSubtitle: "Limites efetivos do {{plan}} · máximo = teto de packs",
      clicksTitle: "Cliques",
      domainsTitle: "Domínios",
      campaignsTitle: "Campanhas",
      quotaUsed: "{{bought}} de {{max}} pacotes neste ciclo",
      capacityUsed: "{{used}} de {{effective}} · máximo {{cap}}",
      renewsOn: "renova {{date}}",
      unitClicks: "+{{n}} cliques",
      unitSlotDomain: "+1 domínio",
      unitSlotCampaign: "+1 campanha",
      comingSoon: "Em breve",
      buyCta: "Comprar {{price}}/mês",
      buySuccessTitle: "Pack adicionado",
      buySuccessDesc: "Sua assinatura foi atualizada.",
      buyErrorTitle: "Não foi possível comprar o pack",
      atCap: "Máximo do {{plan}}",
      atCapClicks: "Máximo do {{plan}}: {{cap}} cliques",
      cycleQuota: "Quota de packs de clique esgotada neste ciclo.",
      unlimited: "Ilimitado no seu plano",
      overLimitRemove: "Remova {{n}} para voltar ao limite",
      overLimitBuy: "ou compre {{n}} slot(s) quando disponível",
      viewPlans: "Ver planos",
      backToDomains: "Voltar para Domínios",
      backToCampaigns: "Voltar para Campanhas",
      backToDashboard: "Voltar ao painel",
      inactivePastDue: "Pagamento pendente — regularize para comprar packs.",
      inactiveCanceled: "Assinatura encerrada.",
      inactivePastDueCta: "Regularize para comprar",
      inactiveCanceledCta: "Assinatura encerrada",
      bypassManaged: "Plano gerenciado pelo suporte",
      badgeAtLimit: "Limite atingido",
      badgeOverLimit: "Acima do limite",
    },
    ...
    addonConfirmTitle: "Confirmar adição de slot",
    addonConfirmDesc: "Você está adicionando 1 slot extra de {{addon}} à sua assinatura.",
    addonDomainLabel: "Domínio",
    addonCampaignLabel: "Campanha",
    addonRecurringCost: "Custo recorrente mensal",
    addonProrationWarning: "Uma cobrança proporcional pode ser aplicada imediatamente no seu cartão de crédito, referente aos dias restantes do ciclo atual. A partir do próximo ciclo, o valor cheio será cobrado mensalmente.",
    addonCancel: "Cancelar",
    addonConfirmButton: "Confirmar pagamento",
    addonProcessing: "Processando...",
    addonGenericError: "Não foi possível adicionar o slot. Tente novamente.",
  },
...
accountDeleted: {
  ...
  auth: {
    ...
    checkEmailBody: "Abrimos um e-mail para {{email}}. Clique no link para ativar a conta — você já entra logado, sem digitar a senha de novo.",
    backToSignIn: "Voltar ao login",
    emailNotConfirmed: "Confirme seu e-mail pelo link que enviamos antes de entrar.",
    accessOpenNote: "Crie sua conta grátis. Campanhas e domínios liberam após escolher um plano.",
