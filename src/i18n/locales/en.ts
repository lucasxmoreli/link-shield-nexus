const en = {
  ...
  campaignEdit: {
    ...
    domainLabel: "Domain",
    domainHelper: "Make sure your domain is pointed via CNAME to proxy.cloakerguard.shop.",
    ...
    domainSslPending: "SSL Pending",
    domainSslWarning: "This domain's SSL is not active yet. The campaign may not work until provisioning completes.",
  ...
  domains: {
    ...
    domainPending: "Domain is still pending. Ensure your CNAME record points to proxy.cloakerguard.shop.",
    url: "URL",
    created: "Created",
    sslStatus: "SSL",
    ...
    cnameStep3Auto: "That's it! Your secure connection will be activated automatically.",
    settingUpSecure: "Setting up secure connection...",
    settingUpSecureDesc: "We're verifying your DNS and provisioning SSL. This may take a few minutes.",
    refreshStatus: "Refresh Status",
    sslReady: "SSL certificate provisioned and domain is ready for traffic.",
    type: "Type",
    nameHost: "Name / Host",
    value: "Value",
    target: "Target",
    ...
    cnameNote: "Your domain is automatically routed through our secure proxy with SSL. No manual setup required.",
    txtFallbackTitle: "Alternative TXT Verification",
    txtFallbackWarning: "If your DNS provider doesn't support CNAME on the root (@), add these two TXT records instead.",
    txtFallbackLink: "Having trouble with a root domain (@)? Click here for alternative TXT verification.",
