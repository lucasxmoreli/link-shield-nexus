const en = {
  ...
  domains: {
    ...
    setupDomainDesc: "Create a CNAME record at your DNS provider to connect",
    ...
    created: "Created",
    sslStatus: "SSL",
    cnameStep1: "Go to your domain's DNS provider (Hostinger, GoDaddy, Namecheap, etc.).",
    cnameStep2: "Create a CNAME record with the following values:",
    cnameStep3: "Save your changes and wait for DNS propagation (usually 5-30 minutes). Then click 'Check Status' below.",
    type: "Type",
    nameHost: "Name / Host",
    value: "Value",
    target: "Target",
